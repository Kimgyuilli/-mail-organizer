...
│   │   │   ├── feedback.py     # 사용자 피드백
│   │   │   ├── background_sync.py # 스케줄러
│   │   │   └── helpers.py      # 공통 헬퍼
│   │   └── models/             # DB 모델 (SQLAlchemy)
│   │       ├── base.py, user.py, mail.py, label.py, sync_state.py
│   ├── tests/                  # pytest 테스트
│   ├── pyproject.toml
│   └── .env                    # 시크릿 (git 미추적)
...
│   │   │   ├── AppHeader.tsx, CategorySidebar.tsx, MailListView.tsx
│   │   │   ├── MailListItem.tsx, MailDetailView.tsx, Pagination.tsx
│   │   │   ├── LoginScreen.tsx, NaverConnectModal.tsx
│   │   │   └── CategoryBadge.tsx, SourceBadge.tsx
│   │   ├── hooks/              # 커스텀 훅
│   │   │   ├── useAuth.ts, useMessages.ts, useMailActions.ts
│   │   │   ├── useCategoryCounts.ts, useFeedbackStats.ts
│   │   │   ├── useNaverConnect.ts, useDragAndDrop.ts
│   │   ├── lib/                # API 클라이언트, 유틸
...
### v2 (계획 중)
- v2 태스크는 기획 후 [PLAN.md](./PLAN.md)에 추가
